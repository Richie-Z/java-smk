...
public class Form extends javax.swing.JFrame {
    ...
    private void openbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_openbtnMouseClicked
        ...
        FileNameExtensionFilter Filemp3 = new FileNameExtensionFilter("mp3","wav");
        openFileChooser.addChoosableFileFilter(Filemp3);
        int result = openFileChooser.showOpenDialog(null);
        if(result == JFileChooser.APPROVE_OPTION){
            songFile = openFileChooser.getSelectedFile();
            songname.setText(songFile.getName());
            try{
            String main = songFile.getPath();
            songFile = new File(main);
            media = new MediaLocator(songFile.toURL());
            System.out.println(media);
            mp3 = Manager.createRealizedPlayer(media);
            }
