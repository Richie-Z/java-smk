 ...
 */
public class HyperlinkBinding extends AbstractBinding implements Binding {

    JButton button;
    LinkAction linkAction;
    
    protected HyperlinkBinding(JButton component, DataModel dataModel, String fieldName) {
